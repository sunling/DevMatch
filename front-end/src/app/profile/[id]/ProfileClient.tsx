            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              {matchInfo && (
                <div className="sm:ml-auto">
                  <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border ${getScoreColor(matchInfo.matchScore)}`}>
                    <span className="text-2xl font-bold">{matchInfo.matchScore}%</span>
